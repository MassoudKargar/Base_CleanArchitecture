using Heris.Extensions.DependencyInjection.Options;

namespace Heris.Extensions.DependencyInjection.Extensions.DependencyInjection;
...
public static class DependencyInjectionServiceCollectionExtensions
{
    ...
    private static bool IsCandidateCompilationLibrary(RuntimeLibrary compilationLibrary, string[] assemblyNames)
        => assemblyNames.Any(d => compilationLibrary.Name.Contains(d)) || compilationLibrary.Dependencies.Any(d => assemblyNames.Any(c => d.Name.Contains(c)));
}
