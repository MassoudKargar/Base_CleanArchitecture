...
public class PersonInsertCommandHandler(IGenericRepository<Person?, long> service, IMapper mapper) :
    Base.Sample.Application.Commands.Handlers.Generics.GenericCreateCommandHandler<long, PersonInsertViewModel, GenericCreateCommand<long, PersonInsertViewModel, BaseCommandResult>, BaseCommandResult, Person>(service, mapper);