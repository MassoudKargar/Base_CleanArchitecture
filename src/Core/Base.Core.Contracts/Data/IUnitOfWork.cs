...
public interface IUnitOfWork
{
    ...
    /// </summary>
    /// <returns>مقدار عددی که نشان‌دهنده تعداد ردیف‌های تأثیرگذار در دیتابیس است.</returns>
    int Commit();

    /// <summary>
    /// برای تایید تراکنشی که اتوماتیک توسط سیستم ایجاد شده است از این متد استفاده می‌شود.
    /// </summary>
    /// <returns>تسک غیرهمزمان که نشان‌دهنده تعداد ردیف‌های تأثیرگذار در دیتابیس است.</returns>
