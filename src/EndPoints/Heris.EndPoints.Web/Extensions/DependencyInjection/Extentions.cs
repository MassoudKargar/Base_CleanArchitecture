...
public static class Extensions
{
        ...
        params string[] assemblyNamesForSearch)
    {
        ...
        services.AddBaseDataAccess(assemblies)
            ...
            .InitializeValidator(assemblies);

        services.AddHerisAutoMapperProfiles(option =>
        {
            option.AssemblyNamesForLoadProfiles = "Heris";
        });
        return services;
    ...
    public static IServiceCollection AddCustomDependencies(this IServiceCollection services, Assembly[] assemblies)
    {
    ...
    public static Assembly[] GetAssemblies(string[] assemblyName)
    {
        ...
        List<Assembly> list = [];
        if (dependencies == null) return list.ToArray();
        list.AddRange(dependencies.Where(library => IsCandidateCompilationLibrary(library, assemblyName))
